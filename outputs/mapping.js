// This file is made by hand (yes, it took some time).
// Started in json, but wanted to add comments, thus changed to JS
// This also allows to integrate with most scrapers 
...
module.exports = function getPermissionName(permissionDescription) {
    return dict[permissionDescription] || '';
}
